...
According to Vassilis

I am far from a Kalman filter expert but through experimentation here is what I found:

RAngle: Is the expected error of the angle from the accels (including noise etc)
QAngle/QGyro: Determines how fast the gyro angle converges to the accelerometer angle. 
I found that if the accelerometer measurement is noisy then you want to have QGyro > QAngle.
